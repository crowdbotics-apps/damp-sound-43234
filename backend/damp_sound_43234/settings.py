"""
Django settings for damp_sound_43234 project.
...
ROOT_URLCONF = 'damp_sound_43234.urls'
...
WSGI_APPLICATION = 'damp_sound_43234.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_sound_43234 API",
    "DESCRIPTION": "API documentation for damp_sound_43234 App",
    "VERSION": "v1",
}
